...
class IntroduceBigTheorem1(Periodicity):
    def construct(self):
        ...
        self.make_convergence_scene(markov_chain_1, 15)
...
class IntroduceBigTheorem4(IntroduceBigTheorem1):
    def construct(self):
        ...
        self.make_convergence_scene(markov_chain_1, 20)
######### Ali Code #########
# Alle 4 Theoreme 1-4 gleichzeitig anzeigen
...
class IntroduceBigTheoremText(Scene):
    def construct(self):
        ...
        how_to_calculate_it = Text("How to calculate the stationary distribution?", weight=BOLD).scale(0.7).shift(DOWN * 3)
...
class PageRankRecap(Scene):
    def construct(self):
        title = Text("PageRank Algorithm", weight=BOLD)
        title.move_to(UP * 3.5)
...
class EigenValueMethodFixed2(Scene):
    ...
    def show_eigen_concept(self, transpose_transition_eq):
        ...
        self.wait()
#############################################################################################################
        title = Text("Eigenvalues/Eigenvectors", weight=BOLD).scale(0.8)
        title.move_to(UP * 3.5)
...
class BeforeAfterComparison(Scene):
    def construct(self):
        ...
        chart = BarChart(
            values=bar_values,
            bar_names=bar_names,
            bar_colors=[YELLOW, PURPLE, REDUCIBLE_GREEN_LIGHTER, PURPLE, REDUCIBLE_GREEN_DARKER],
            y_range=[0, 100, 25],
            y_length=1.8,
            x_length=8,
